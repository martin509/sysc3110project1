...
public class GUIView extends JFrame{
	...
	/**
	 * @author Michael
	 * Create a new board (MUST be called at the start of the game).
	 * @param boardWidth
	 * @parem boardHeight
	 * @parem listener
	 */
	...
	/**
	 * @author Michael
	 * This method is used for the actionlistener in the controller.
	 * @param btn
	 * @return The board coordinates of the given button. NULL if the button is not found in the board.
	 */
